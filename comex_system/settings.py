...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "stock.lote": "fas fa-boxes",
        "stock.movimientostock": "fas fa-exchange-alt",
        "stock.stockconsolidado": "fas fa-warehouse",
    ...
    "topmenu_links": [
        ...
        {"name": "Control de Stock", "url": "/stock/", "permissions": ["auth.view_user"]},
